...
server.on("request", async (request, response) => {
  ...
  if (((url === "/") || (url.includes("/?language="))) && (method === "GET")) await getAbout(ABOUT_TYPE, request, response);
  else if (url.includes("/download?language=") && (method === "GET")) await getAbout(DOWNLOAD_TYPE, request, response);
  ...
  else if (url.includes("/getSkill/") && (method === "GET")) await getItem(SKILL_TYPE, request, response, path.basename(url));
  else if ((url === "/saveSkill") && (method === "POST") && (contentType === "application/json")) await saveItem(SKILL_TYPE, request, response);
  else if (url.includes("/deleteSkill/") && (method === "DELETE")) await deleteItem(SKILL_TYPE, request, response, path.basename(url));
  else if (url.includes("/pinSkill/") && (method === "PUT")) await pinItem(SKILL_TYPE, request, response, path.basename(url));
  else if ((url === "/resume") && (method === "GET")) await getItems(RESUME_ITEM_TYPE, request, response);
  else if (url.includes("/getResumeItem/") && (method === "GET")) await getItem(RESUME_ITEM_TYPE, request, response, path.basename(url));
  else if ((url === "/saveResumeItem") && (method === "POST") && (contentType === "application/json")) await saveItem(RESUME_ITEM_TYPE, request, response);
  else if (url.includes("/deleteResumeItem/") && (method === "DELETE")) await deleteItem(RESUME_ITEM_TYPE, request, response, path.basename(url));
  else if (url.includes("/pinResumeItem/") && (method === "PUT")) await pinItem(RESUME_ITEM_TYPE, request, response, path.basename(url));
  else if ((url === "/portfolio") && (method === "GET")) await getItems(PORTFOLIO_ITEM_TYPE, request, response);
  else if (url.includes("/getPortfolioItem/") && (method === "GET")) await getItem(PORTFOLIO_ITEM_TYPE, request, response, path.basename(url));
  ...
  else if (url.includes("/deletePortfolioItem/") && (method === "DELETE")) await deleteItem(PORTFOLIO_ITEM_TYPE, request, response, path.basename(url));
  else if (url.includes("/pinPortfolioItem/") && (method === "PUT")) await pinItem(PORTFOLIO_ITEM_TYPE, request, response, path.basename(url));
  else if ((url === "/certifications") && (method === "GET")) await getItems(CERTIFICATION_TYPE, request, response);
  else if (url.includes("/getCertification/") && (method === "GET")) await getItem(CERTIFICATION_TYPE, request, response, path.basename(url));
  ...
  else if (url.includes("/deleteCertification/") && (method === "DELETE")) await deleteItem(CERTIFICATION_TYPE, request, response, path.basename(url));
  else if (url.includes("/pinCertification/") && (method === "PUT")) await pinItem(CERTIFICATION_TYPE, request, response, path.basename(url));
  else if ((url === "/customers") && (method === "GET")) await getItems(CUSTOMER_TYPE, request, response);
  else if (url.includes("/getCustomer/") && (method === "GET")) await getItem(CUSTOMER_TYPE, request, response, path.basename(url));
  else if ((url === "/saveCustomer") && (method === "POST") && (contentType === "application/json")) await saveItem(CUSTOMER_TYPE, request, response);
  else if (url.includes("/deleteCustomer/") && (method === "DELETE")) await deleteItem(CUSTOMER_TYPE, request, response, path.basename(url));
  else if (url.includes("/pinCustomer/") && (method === "PUT")) await pinItem(CUSTOMER_TYPE, request, response, path.basename(url));
  else if ((url === "/contacts") && (method === "GET")) await getItems(CONTACT_TYPE, request, response);
  else if (url.includes("/getContact/") && (method === "GET")) await getItem(CONTACT_TYPE, request, response, path.basename(url));
  else if ((url === "/saveContact") && (method === "POST") && (contentType === "application/json")) await saveContact(request, response);
  else if (url.includes("/answerContact/") && (method === "PUT") && (contentType === "application/json")) await answerContact(request, response, path.basename(url));
  else if (url.includes("/deleteContact/") && (method === "DELETE")) await deleteItem(CONTACT_TYPE, request, response, path.basename(url));
  else if (url.includes("/js/") && (method === "GET")) getJsFile(response, path.basename(url));
  else if (url.includes("/utilities/") && (method === "GET")) getUtilityFile(response, path.basename(url));
  else if (url.includes("/css/") && (method === "GET")) getCssFile(response, path.basename(url));
  else if (url.includes("/images/") && (method === "GET")) getImageFile(response, path.basename(url));
